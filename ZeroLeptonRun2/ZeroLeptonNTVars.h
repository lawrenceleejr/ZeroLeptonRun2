...
class NTVars
{
 public:
  ...
  std::vector< float > FatJetM;
  std::vector<float> D2_fat;
  std::vector <bool> isWmedium_fat;
  ...
  std::vector< float > btagSystWeights;
};
...
private:
  ...
  std::vector< float >* p_FatJetPt;
  std::vector< float >* p_FatJetEta;
  std::vector< float >* p_FatJetPhi;
  std::vector< float >* p_FatJetM;
  std::vector< float >* p_D2_fat;
  std::vector< bool >* p_isWmedium_fat;
  ...
  std::vector< float >* p_btagSystWeights;
};
...
class NTCRWTVars
{
 public:
  ...
  //float lep1DRjet;
  //float lep1jetJVF;
  float fakeWeight, fakeWeightUp, fakeWeightDown;
};
...
class NTCR3LVars
{
 public:
  ...
  int lep1Signal, lep2Signal, lep3Signal;
  float mll, Zpt;
  float leptonWeight, leptonWeightUp, leptonWeightDown;
...
class DQVars
{
 public:
  ...
  static std::string toString() {
    return std::string("RunNumber/i:EventNumber/i:LumiBlockNumber/i:LArError/i:TileError/i:SCTError/i:CoreError/i");
  }
  void Reset() {
    RunNumber = 0;
    EventNumber = 0;
  ...
  unsigned int RunNumber, EventNumber, LumiBlockNumber, LArError, TileError, SCTError, CoreError;
};

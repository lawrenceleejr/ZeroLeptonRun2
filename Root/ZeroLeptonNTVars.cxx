...
NTVarsRead::NTVarsRead(): ntv()
{
  ...
  p_FatJetPt   = &ntv.FatJetPt;
  p_FatJetEta  = &ntv.FatJetEta;
  p_FatJetPhi  = &ntv.FatJetPhi;
  p_FatJetM    = &ntv.FatJetM;
  p_D2_fat     = &ntv.D2_fat;
  p_isWmedium_fat = &ntv.isWmedium_fat;
  ...
  p_btagSystWeights = &ntv.btagSystWeights;
}
...
void NTVarsRead::setAddresses(TTree* tree, bool addJetSmearSystW)
{
  ...
  tree->GetBranch("FatJetPt")->SetAddress(&p_FatJetPt);
  tree->GetBranch("FatJetEta")->SetAddress(&p_FatJetEta);
  tree->GetBranch("FatJetPhi")->SetAddress(&p_FatJetPhi);
  tree->GetBranch("FatJetM")->SetAddress(&p_FatJetM);
  tree->GetBranch("D2_fat")->SetAddress(&p_D2_fat);
  tree->GetBranch("isWmedium_fat")->SetAddress(&p_isWmedium_fat);
  ...
  tree->GetBranch("btagSystWeights")->SetAddress(&p_btagSystWeights);
...
{
  return std::string("lep1Pt/F:lep1Eta/F:lep1Phi/F:lep1sign/I:lep1Signal/I:mt/F:Wpt/F:dphilMET/F:Weta/F:lep1ptvarcone20/F:lep1ptvarcone30/F:lep1topoetcone20/F:fakeWeight/F:fakeWeightUp/F:fakeWeightDown/F");
...
{
  return std::string("lep1Pt/F:lep2Pt/F:lep3Pt/F:lep1Eta/F:lep2Eta/F:lep3Eta/F:lep1Phi/F:lep2Phi/F:lep3Phi/F:lep1sign/I:lep2sign/I:lep3sign/I:lep1Signal/I:lep2Signal/I:lep3Signal/I:mll/F:Zpt/F:leptonWeight/F:leptonWeightUp/F:leptonWeightDown/F:lep1ptvarcone20/F:lep2ptvarcone20/F:lep3ptvarcone20/F:lep1ptvarcone30/F:lep2ptvarcone30/F:lep3ptvarcone30/F:lep1topoetcone20/F:lep2topoetcone20/F:lep3topoetcone20/F:mt/F:Wpt/F:lepfromW/I:fakeWeight/F:fakeWeightUp/F:fakeWeightDown/F");
}
...
void NTCR3LVars::Reset()
{
  ...
  lep3sign = 0;
  lepfromW = 0;
  lep1Signal = lep2Signal = lep3Signal = 0;
  mll = 0.f;
  Zpt = 0.f;
  mt = 0.f;
  Wpt = 0.f;
  ...
  fakeWeight = fakeWeightUp = fakeWeightDown = 0.f;
}
...
void bookNTVars(TTree* tree, NTVars& ntv, bool addJetSmearSystW)
{
  ...
  tree->Branch("FatJetPt",&(ntv.FatJetPt));
  tree->Branch("FatJetEta",&(ntv.FatJetEta));
  tree->Branch("FatJetPhi",&(ntv.FatJetPhi));
  tree->Branch("FatJetM",&(ntv.FatJetM));
  tree->Branch("D2_fat",&(ntv.D2_fat));
  tree->Branch("isWmedium_fat",&(ntv.isWmedium_fat));
  ...
  tree->Branch("btagSystWeights",&(ntv.btagSystWeights));
  treePolicies(tree);
}

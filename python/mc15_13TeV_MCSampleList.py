...
lZjets  += range(363391,363411+1) # Sherpa 2.2 Zee
...
lWjets   = range(363463,363483+1) # Sherpa 2.2 Wenu missing pt<70
lWjets  += range(363439,363459+1) # Sherpa 2.2 Wmunu  missing pt<70
lWjets  += range(363334,363354+1) # Sherpa 2.2 Wtaunu  

...
def main():
    ...
    for inDS in linDS:
        ...
        outputs = "o.root" 
        scriptcmd = r"""cp ../PoolFileCatalog.xml . ; ZeroLeptonRun2/python/pfc2txt.py; cat pfc.txt; echo %IN| sed 's/\,/\n/g'>inputfiles; unset ROOT_TTREECACHE_SIZE; ln -sf ${ROOTCOREBIN}/../CDIFiles/13TeV/2015-PreRecomm-13TeV-MC12-CDI_July15-v1.root . ; cafe """ + cafeconfig + """ Events: -1  Input: filelist:inputfiles  Output: o.root """ 
